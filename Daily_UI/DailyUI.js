$(document).ready(function() {
    ...
    .prepend(
        '<div class="newPost">' + 
            '<a href="../Day4_Calculator/Day4Index.html">' + 
    ...
    .prepend(
        '<div class="newPost">' + 
            '<a href="../../project/plotlyJS/plotly1.html">' + 
                '<h5>畫圖表? plotly.js!</h5><img src="../../index/img/plotly1.png">' + 
    ...
    .prepend(
        '<div class="newPost">' + 
            '<a href="../Day6_User_profile/Day6Index.html">' + 
